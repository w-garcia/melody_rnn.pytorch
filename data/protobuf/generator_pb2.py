...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_pb=_b('\n\x0fgenerator.proto\x12\x12melody_rnn.pytorch\"3\n\x10GeneratorDetails\x12\n\n\x02id\x18\x01 \x01(\t\x12\x13\n\x0b\x64\x65scription\x18\x02 \x01(\t\"\x89\x04\n\x10GeneratorOptions\x12L\n\x0einput_sections\x18\x01 \x03(\x0b\x32\x34.melody_rnn.pytorch.GeneratorOptions.SequenceSection\x12O\n\x11generate_sections\x18\x02 \x03(\x0b\x32\x34.melody_rnn.pytorch.GeneratorOptions.SequenceSection\x12<\n\x04\x61rgs\x18\x03 \x03(\x0b\x32..melody_rnn.pytorch.GeneratorOptions.ArgsEntry\x1a\x37\n\x0fSequenceSection\x12\x12\n\nstart_time\x18\x01 \x01(\x01\x12\x10\n\x08\x65nd_time\x18\x02 \x01(\x01\x1a\x82\x01\n\x08\x41rgValue\x12\x14\n\nbyte_value\x18\x01 \x01(\x0cH\x00\x12\x13\n\tint_value\x18\x02 \x01(\x05H\x00\x12\x15\n\x0b\x66loat_value\x18\x03 \x01(\x01H\x00\x12\x14\n\nbool_value\x18\x04 \x01(\x08H\x00\x12\x16\n\x0cstring_value\x18\x05 \x01(\tH\x00\x42\x06\n\x04kind\x1aZ\n\tArgsEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12<\n\x05value\x18\x02 \x01(\x0b\x32-.melody_rnn.pytorch.GeneratorOptions.ArgValue:\x02\x38\x01\"\xf4\x01\n\x0fGeneratorBundle\x12?\n\x11generator_details\x18\x01 \x01(\x0b\x32$.melody_rnn.pytorch.GeneratorDetails\x12I\n\x0e\x62undle_details\x18\x04 \x01(\x0b\x32\x31.melody_rnn.pytorch.GeneratorBundle.BundleDetails\x12\x17\n\x0f\x63heckpoint_file\x18\x02 \x03(\x0c\x12\x16\n\x0emetagraph_file\x18\x03 \x01(\x0c\x1a$\n\rBundleDetails\x12\x13\n\x0b\x64\x65scription\x18\x01 \x01(\tb\x06proto3')
)
...
_GENERATORDETAILS = _descriptor.Descriptor(
  ...
  full_name='melody_rnn.pytorch.GeneratorDetails',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='melody_rnn.pytorch.GeneratorDetails.id', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='description', full_name='melody_rnn.pytorch.GeneratorDetails.description', index=1,
...
_GENERATOROPTIONS_SEQUENCESECTION = _descriptor.Descriptor(
  ...
  full_name='melody_rnn.pytorch.GeneratorOptions.SequenceSection',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='start_time', full_name='melody_rnn.pytorch.GeneratorOptions.SequenceSection.start_time', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='end_time', full_name='melody_rnn.pytorch.GeneratorOptions.SequenceSection.end_time', index=1,
...
_GENERATOROPTIONS_ARGVALUE = _descriptor.Descriptor(
  name='ArgValue',
  full_name='melody_rnn.pytorch.GeneratorOptions.ArgValue',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='byte_value', full_name='melody_rnn.pytorch.GeneratorOptions.ArgValue.byte_value', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='int_value', full_name='melody_rnn.pytorch.GeneratorOptions.ArgValue.int_value', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='float_value', full_name='melody_rnn.pytorch.GeneratorOptions.ArgValue.float_value', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='bool_value', full_name='melody_rnn.pytorch.GeneratorOptions.ArgValue.bool_value', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='string_value', full_name='melody_rnn.pytorch.GeneratorOptions.ArgValue.string_value', index=4,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='kind', full_name='melody_rnn.pytorch.GeneratorOptions.ArgValue.kind',
...
_GENERATOROPTIONS_ARGSENTRY = _descriptor.Descriptor(
  name='ArgsEntry',
  full_name='melody_rnn.pytorch.GeneratorOptions.ArgsEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='melody_rnn.pytorch.GeneratorOptions.ArgsEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='value', full_name='melody_rnn.pytorch.GeneratorOptions.ArgsEntry.value', index=1,
...
_GENERATOROPTIONS = _descriptor.Descriptor(
  ...
  full_name='melody_rnn.pytorch.GeneratorOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='input_sections', full_name='melody_rnn.pytorch.GeneratorOptions.input_sections', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='generate_sections', full_name='melody_rnn.pytorch.GeneratorOptions.generate_sections', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='args', full_name='melody_rnn.pytorch.GeneratorOptions.args', index=2,
...
_GENERATORBUNDLE_BUNDLEDETAILS = _descriptor.Descriptor(
  name='BundleDetails',
  full_name='melody_rnn.pytorch.GeneratorBundle.BundleDetails',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='description', full_name='melody_rnn.pytorch.GeneratorBundle.BundleDetails.description', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GENERATORBUNDLE = _descriptor.Descriptor(
  ...
  full_name='melody_rnn.pytorch.GeneratorBundle',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='generator_details', full_name='melody_rnn.pytorch.GeneratorBundle.generator_details', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='bundle_details', full_name='melody_rnn.pytorch.GeneratorBundle.bundle_details', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='checkpoint_file', full_name='melody_rnn.pytorch.GeneratorBundle.checkpoint_file', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='metagraph_file', full_name='melody_rnn.pytorch.GeneratorBundle.metagraph_file', index=3,
...
GeneratorDetails = _reflection.GeneratedProtocolMessageType('GeneratorDetails', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:melody_rnn.pytorch.GeneratorDetails)
  ))
...
GeneratorOptions = _reflection.GeneratedProtocolMessageType('GeneratorOptions', (_message.Message,), dict(
  ...
  SequenceSection = _reflection.GeneratedProtocolMessageType('SequenceSection', (_message.Message,), dict(
    ...
    __module__ = 'generator_pb2'
    # @@protoc_insertion_point(class_scope:melody_rnn.pytorch.GeneratorOptions.SequenceSection)
    ))
  ,
  ...
  ArgValue = _reflection.GeneratedProtocolMessageType('ArgValue', (_message.Message,), dict(
    ...
    __module__ = 'generator_pb2'
    # @@protoc_insertion_point(class_scope:melody_rnn.pytorch.GeneratorOptions.ArgValue)
    ))
  ,
  ...
  ArgsEntry = _reflection.GeneratedProtocolMessageType('ArgsEntry', (_message.Message,), dict(
    ...
    __module__ = 'generator_pb2'
    # @@protoc_insertion_point(class_scope:melody_rnn.pytorch.GeneratorOptions.ArgsEntry)
    ))
  ,
  DESCRIPTOR = _GENERATOROPTIONS,
  __module__ = 'generator_pb2'
  # @@protoc_insertion_point(class_scope:melody_rnn.pytorch.GeneratorOptions)
  ))
...
GeneratorBundle = _reflection.GeneratedProtocolMessageType('GeneratorBundle', (_message.Message,), dict(
  ...
  BundleDetails = _reflection.GeneratedProtocolMessageType('BundleDetails', (_message.Message,), dict(
    ...
    __module__ = 'generator_pb2'
    # @@protoc_insertion_point(class_scope:melody_rnn.pytorch.GeneratorBundle.BundleDetails)
    ))
  ,
  DESCRIPTOR = _GENERATORBUNDLE,
  __module__ = 'generator_pb2'
  # @@protoc_insertion_point(class_scope:melody_rnn.pytorch.GeneratorBundle)
  ))

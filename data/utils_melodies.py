...
import data.utils_events as events_lib
import data.utils_midi as midi_io
import data.utils_sequences as sequences_lib
from data.protobuf import music_pb2
...
def extract_melodies(quantized_sequence,
    ...
    # TODO(WG): could really care less about stats now, maybe re add them later
